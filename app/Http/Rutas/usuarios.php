...
Route::get('user/api/getOpciones',['as'=>'getOpciones','uses'=>'AdministracionUserController@getOpciones']);

//save
Route::post('user/api/saveOpcionModulo',['as'=>'apiSaveOpcionModulo','uses'=>'AdministracionUserController@apiSaveOpcionModulo']);
