                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; border-radius: 3px; background: #fff; margin: 0; border: 1px solid #e9e9e9;">
                    ...
                    <tr style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class="content-wrap" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 20px;" valign="top">
                            <table width="100%" border=1 cellspacing=0 cellpadding=2 bordercolor="666633" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                <tr>
                                    <td style="padding: 3px;">FICHA</td>
                                    <td style="padding: 3px;">DNI</td>
                                    <td>NOMBRE</td>
                                    <td>FECHA_INICIO</td>
                                    <td>FECHA_TERMINO</td>
                                </tr>
                                @foreach( $contratos as $i )
                                    <tr>
                                        <td style="padding: 3px;">{{$i->FICHA}}</td>
                                        <td style="padding: 3px;" >{{ $i->DNI }}</td>
                                        <td>{{ $i->NOMBRE }}</td>
