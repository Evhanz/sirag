...
@section('content')
                                ...
                                <div class="tab-content">
                                    <div id="home" class="tab-pane fade in active">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label for="">Año</label><br>
                                                <select name="" id="anioJOR" class="form-control">
                                                    <option value="">----------</option>
                                                    <option value="2017">2017</option>
                                                    <option value="2016">2016</option>
                                                    <option value="2015">2015</option>
                                            ...
                                            <div class="col-md-2">
                                                <label for="">Mes</label><br>
                                                <select name="" id="mesJOR" class="form-control">
                                                    <option value="">----------</option>
                                                    <option value="01">Enero</option>
                                                    <option value="02">Febrero</option>
                                                    <option value="03">Marzo</option>
                                            ...
                                            <div class="col-md-2">
                                                <br>
                                                <button href="" class="btn btn-default" ng-click="getDataJOR()" id="btnExportarJOR" >
                                                    <i class="fa fa-print fa-lg"></i> Exportar TXT </button>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        app.controller("PruebaController", function($scope,$http,$window) {
            ...
            $scope.getDataJOR =  function ()
            {

                var token = $('#_token').val();
                var anio  = $('#anioJOR').val();
                var mes  = $('#mesJOR').val();
                ...
                if (periodo.length == 6 ) {
                    ...
                    var ruta = '{{ URL::route('getPlameJOR') }}';

                    $('#btnExportarJOR').attr("disabled", true);
                    $scope.Documentos = [];
                    $("#box_maestro").append("<div class='overlay'></div><div class='loading-img'></div>");
                    ...
                    $http.post(ruta,{_token : token,
                        ...
                        f_fin:f_fin
                            ...
                            .success(function(data){
                                $('#btnExportarJOR').attr("disabled", false);
                                console.log(data);
                                var url = data;
                                window.location = url;
